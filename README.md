...
JScrambler.java
---------------
JScrambler Java client

DownloadExample.java
---------------------
Simple program that uses JScrambler client in java to download obfuscated JavaScript project.

PollExample.java
-----------------
Simple program that uses JScrambler client in java to upload a JavaScript project for obfuscation and poll the server to download the obfuscated project as soon as is finished.

UploadExample.java
------------------
Simple program that uses JScrambler client in java to upload a JavaScript project for obfuscation.

config.json
-----------
Configuration file in json that is consumed by PollExample.java
